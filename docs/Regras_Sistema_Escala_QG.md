...
- **3.3.1 Participação restrita a uma cor:** em cada escala, o participante concorre **nas duas cores** (padrão) ou **em apenas uma delas**. É o caso do militar cuja função o impede de servir em dia útil: ele participa da escala, mas **só é escalado nos fins de semana e feriados**. Não se confunde com a **cor da escala** (4.2), que diz em que dias a escala roda: aqui a escala roda as duas cores e é a **pessoa** que concorre em uma só. Efeitos: o militar simplesmente **não entra na fila** da cor de que não participa (não é "pulado", não guarda vez ali — regra 6.4 vale só para impedimento); a **folga mínima continua valendo em qualquer cor e qualquer escala concorrente** (7.4), de modo que quem serviu no sábado segue impedido de assumir na segunda; e o efetivo mínimo (4.3/7.8) passa a ser conferido **cor a cor**, porque participante de uma cor só não sustenta a outra.
...
- **10.5 A folga mínima NÃO barra a troca** (decisão do Sargento Brigada, 01/08/2026 — revoga a barreira anterior). Cobrir um serviço **não conta na folga de quem cobre**: a troca fica apenas registrada, e a contagem de folga permanece com o **substituído** (é a mesma coisa que a 10.2 diz, aplicada também à autorização da troca). Como não há o que contar do lado de quem cobre, não há folga a ferir — a troca é aceita.
  - **Por que a barreira caiu:** ela negava trocas legítimas entre dias **previstos**. Exemplo real: o João está previsto para o dia 12 e quer trocar com o Paulo, previsto para o 13. O sistema recusava por "24h < 48h", contando contra o João o serviço do dia 12 — que, feita a troca, ele não cumpre.
  - **O que continua barrando a troca** (impossibilidade, não equidade): (a) quem vai cobrir está **impedido** no dia (dispensa, férias, curso — regra 7.5); (b) quem vai cobrir **já está de serviço nesse mesmo dia**, na escala ou numa concorrente; (c) o substituto é o próprio escalado, ou o serviço já tem permuta registrada.
  - **Consequência aceita:** o sistema não impede que o mesmo militar cumpra serviços em dias seguidos por efeito de uma troca. Quem autoriza a troca é o gestor, e é dele o juízo sobre o descanso. A escalação automática (seção 7) **não muda**: ali a folga mínima continua valendo integralmente.
